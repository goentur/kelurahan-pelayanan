...
import { BreadcrumbItem, Gate, InfoDataTabel } from '@/types'
...
export default function Index({ gate, tipePenyampaian }: IndexProps) {
    ...
    const handleForm = (e: React.FormEvent) => {
        ...
        const routeName = isEdit
            ? (route('master.jenis-lapor.update', data) as string)
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <FormDialog
                ...
                tipePenyampaian={tipePenyampaian}
            />
            <Delete
                open={hapus}
                setOpen={setHapus}

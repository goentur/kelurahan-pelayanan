import { convertTextToSymbol } from "@/lib/utils";
import { Building2, LandPlot, MapPin } from "lucide-react";
type props = {
    kirim: any
    data: any
}
export default function Umum({kirim, data} : props) {
     return (
          <>
                                   ...
                                   <table className="w-full">
                                        <tbody>
                                             <tr className="border-b align-top">
                                                  ...
                                                  <td className="py-1 text-center align-top w-[10%]">:</td>
                                                  <td className="py-1 text-left align-top">{data.subjek.npwp ? convertTextToSymbol(data.subjek.npwp) : null}</td>
                                             </tr>
                                             <tr className="border-b align-top">
                                                  <td className="py-1 text-left align-top font-medium">NAMA</td>
                                                  <td className="py-1 text-center align-top">:</td>
                                                  <td className="py-1 text-left align-top">{kirim.admin ? data.subjek.nama : (data.subjek.nama ? convertTextToSymbol(data.subjek.nama) : null)}</td>
                                             </tr>
                                             <tr className="border-b align-top">
                                             ...
                                             <tr className="align-top">
                                                  <td className="py-1 text-left align-top font-medium">ALAMAT</td>
                                                  <td className="py-1 text-center align-top">:</td>
                                                  <td className="py-1 text-left align-top">{kirim.admin ? data.subjek.alamat : (data.subjek.alamat ? convertTextToSymbol(data.subjek.alamat) : null)}</td>
                                             </tr>
                                        </tbody>
                                   </table>
                              </div>
